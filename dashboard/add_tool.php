...
$show = $info = $list = $list1 = '';
$list = $tools->tools_list();
$list1 = $users->users_list();
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="tools.php">
                    ...
                    <form action="" method="POST" novalidate class="needs-validation">
                        ...
                        <div class="form-group mb-3 row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="directory" id="directory" required class="form-control">
                                    <option value="" selected disabled>Select tool directory</option>
                                    <?php echo $list; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group mb-3 row">
                            <div class="col-sm-6">
                                <label for="u_id">Submitted by:</label>
                                <select name="u_id" id="u_id" required class="form-control">
