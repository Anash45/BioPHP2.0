...
<head>
    ...
    <title>Dashboard - Shop Mnagement</title>
...
<body>
    ...
    <main>
        <div class="container">
            <section class="form py-5">
                <h1 class="title mb-4 text-center">Admin Login</h1>
                <div class="col-md-6 col-sm-8 col-12 mx-auto">
                    <div class="card p-sm-5 py-4 px-3">
                        <form action="" class="needs-validation" novalidate method="post">
                            ...
                            <div class="form-group mb-3">
                                <p class="m-0"><a href="login.php" class="text-primary">User Login</a></p>
                            </div>
    ...
    <footer class="pt-5 my-5 text-muted border-top text-center">
        Dashboard - Shop Mnagement &copy; All Rights Reserved
        <script>
            var dt = new Date();
